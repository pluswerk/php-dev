...
alias node='sudo docker exec -u1000 -w $(pwd) -it ${NODE_CONTAINER} node'
alias npm='sudo docker exec -u1000 -w $(pwd) -it ${NODE_CONTAINER} npm'
alias yarn='sudo docker exec -u1000 -w $(pwd) -it ${NODE_CONTAINER} yarn'
alias node_exec='sudo docker exec -u1000 -w $(pwd) -it ${NODE_CONTAINER}'
